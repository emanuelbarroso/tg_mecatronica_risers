...
Vídeos foram criados para cada um destes casos e estão disponíveis no YouTube{\sffamily\textregistered\textcopyright}, tanto para a trajetória modelada\footnote{
Controle Malha Aberta Modelado com Trajetória de 30cm - \url{https://youtu.be/lKajz6LyauE}} quanto para a trajetória com velocidade constante\footnote{
Controle Malha Aberta a Velocidade Constante com Trajetória de 30cm -\url{https://youtu.be/tB0TsmBcfVg}}.
...
Valores de $K_p$ foram escolhidos empiricamente e o resultado para $K_p = 0.0025$\footnote{Controle Malha Fechada da Ponte Rolante com Kp = 0.0025 - \url{https://youtu.be/mmT1ZwFBJ4s}} está na Figura \ref{MFProporcionalKpbaixo} enquanto para $K_p = 0.0050$\footnote{Controle Malha Fechada da Ponte Rolante com Kp = 0.0050 - \url{https://youtu.be/sHh3yvBrek4}} está na Figura \ref{MFProporcionalKpmedio}.
