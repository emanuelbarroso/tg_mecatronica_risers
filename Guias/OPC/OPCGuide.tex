...
\huge Utilização de uma rede OPC para comunicação entre controlador e \textit{softwares} externos usando linguagem de programação \textit{Python} \\ % The assignment title
